...
// CommonDialog library
constexpr int ORBIS_COMMON_DIALOG_ERROR_NOT_SYSTEM_INITIALIZED = 0x80B80001;
constexpr int ORBIS_COMMON_DIALOG_ERROR_ALREADY_INITIALIZED = 0x80B80004;
constexpr int ORBIS_COMMON_DIALOG_ERROR_BUSY = 0x80B80008;
constexpr int ORBIS_COMMON_DIALOG_ERROR_OUT_OF_MEMORY = 0x80B80009;
constexpr int ORBIS_COMMON_DIALOG_ERROR_UNEXPECTED_FATAL = 0x80B8000E;